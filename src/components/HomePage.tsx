      ...
      {isLoading ? (
        ...
        <div className="space-y-4">
          {observations.map((obs) => (
            <Card key={obs.id} className="cursor-pointer">
              <CardContent>
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex gap-2 mt-3">
                      <Button size="sm" onClick={() => openDetails(obs)}>View</Button>
                      <Button size="sm" variant="outline" onClick={() => handleStartSuggest(obs.id)}>Suggest ID</Button>
                      <Button size="sm" variant="ghost" onClick={() => { setSelectedObs(obs); setShowModal(true); }}>Comment</Button>
                    </div>
